...
(function (root) {
     ...
     *
     * Examples: "*whatever*", "*.amazon.com", "mysite-*" are patterns;
     * "www.amazon.com" is a literal.
     */
     ...
     * ^...$ so, e.g., "*.amazon.com" matches "www.amazon.com" but not
     * "www.amazon.com.evil.net".
     *
     ...
     * (non-"*") characters wins, so "*.prod.amazon.com" beats "*whatever*".
     */
     ...
     * pattern such as "*whatever*"). Callers should write level changes back to
